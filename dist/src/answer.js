...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const copyUrl = () => __awaiter(void 0, void 0, void 0, function* () {
        var _a;
        try {
            const currentUrl = window.location.href; // 현재 페이지 URL 가져오기
            (_a = document.querySelector("#copyBtn")) === null || _a === void 0 ? void 0 : _a.classList.toggle('on');
            yield navigator.clipboard.writeText(currentUrl); // 클립보드에 복사
            setTimeout(() => {
                var _a;
                (_a = document.querySelector("#copyBtn")) === null || _a === void 0 ? void 0 : _a.classList.toggle('on');
            }, 500);
    ...
    (_a = document.querySelector('#copyBtn')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', copyUrl);
});
